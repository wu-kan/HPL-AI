 ...
 * =======
 *
 * HPL_AI_papanel_init initializes a panel data structure.
 * 
 *
 * Arguments
 * =========
 ...
 *
 * A       (local input/output)          HPL_AI_T_pmat *
 ...
 */
   ...
   PANEL->A       = Mptr( (HPL_AI_T_afloat *)(A->A), ii, jj, A->ld );
/*
 ...
 * buffer.
 */
   dalign = ALGO->align * sizeof( HPL_AI_T_afloat );
   ...
   {                                     /* space for L1, DPIV, DINFO */
      ...
      if( !( PANEL->WORK = (HPL_AI_T_afloat *)malloc( (size_t)(lwork) * 
                                           sizeof( HPL_AI_T_afloat ) ) ) )
      {
         HPL_pabort( __LINE__, "HPL_AI_papanel_init",
 ...
 */
      ...
      PANEL->ldl2  = A->ld;
      PANEL->L1    = (HPL_AI_T_afloat *)HPL_PTR( PANEL->WORK, dalign );
 ...
 */
#ifdef HPL_COPY_L
      PANEL->L2    = (HPL_AI_T_afloat *)HPL_PTR( PANEL->WORK, dalign );
 ...
 */
   ...
   if( PANEL->IWORK == NULL )
   { HPL_pabort( __LINE__, "HPL_AI_papanel_init", "Memory allocation failed" ); }
                       /* Initialize the first entry of the workarray */
   *(PANEL->IWORK) = -1;
/*
 * End of HPL_AI_papanel_init
 */
}
