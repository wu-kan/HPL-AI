 ...
 * =======
 *
 * HPLAI_alamch determines  machine-specific  arithmetic constants such as
 ...
 *         Specifies the value to be returned by HPLAI_alamch             
 *            = HPL_MACH_EPS,   HPLAI_alamch := eps (default)             
 *            = HPL_MACH_SFMIN, HPLAI_alamch := sfmin                     
 *            = HPL_MACH_BASE,  HPLAI_alamch := base                      
 *            = HPL_MACH_PREC,  HPLAI_alamch := eps*base                  
 *            = HPL_MACH_MLEN,  HPLAI_alamch := t                         
 *            = HPL_MACH_RND,   HPLAI_alamch := rnd                       
 *            = HPL_MACH_EMIN,  HPLAI_alamch := emin                      
 *            = HPL_MACH_RMIN,  HPLAI_alamch := rmin                      
 *            = HPL_MACH_EMAX,  HPLAI_alamch := emax                      
 *            = HPL_MACH_RMAX,  HPLAI_alamch := rmax                      
 *          
 *         where                                                        
 *          
 ...
 * =======
 *
 * HPLAI_alamc1  determines  the machine parameters given by BETA, T, RND,
 * and IEEE1.
 *
 * Notes
 * =====
 ...
 * =======
 *
 * HPLAI_alamc2  determines the machine  parameters specified in its argu-
 * ment list.
 *
 * Notes
 * =====
 ...
 *         way in which the machine performs its arithmetic.
 *
 * EPS     (local output)              HPLAI_T_AFLOAT *
 ...
 *
 * RMIN    (local output)              HPLAI_T_AFLOAT *
 ...
 *
 * RMAX    (local output)              HPLAI_T_AFLOAT *
 ...
 *
 * Throughout this routine we use the function HPLAI_alamc3 to ensure that
 ...
 * =======
 *
 * HPLAI_alamc3  is intended to force a and b  to be stored prior to doing
 ...
 * =========
 *
 * A, B    (local input)               HPLAI_T_AFLOAT
 *         The values a and b.
 *
 * ---------------------------------------------------------------------
 */
 ...
 * =======
 *
 * HPLAI_alamc4 is a service function for HPLAI_alamc2.
 *
 * Notes
 * =====
 *
 ...
 *
 * START   (local input)               HPLAI_T_AFLOAT
 ...
 * =======
 *
 * HPLAI_alamc5  attempts  to compute RMAX, the largest machine  floating-
 ...
 * =======
 *
 * HPLAI_aipow computes the integer n-th power of a real scalar x.
 *
 * Arguments
 * =========
 *
