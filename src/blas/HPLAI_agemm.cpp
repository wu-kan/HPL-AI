...
#else
static void HPLAI_agemmNN( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC )
   const int                  K, LDA, LDB, LDC, M, N;
   const HPLAI_T_AFLOAT               ALPHA, BETA;
   const HPLAI_T_AFLOAT               * A, * B;
   HPLAI_T_AFLOAT                     * C;
#endif
{
...
#else
static void HPLAI_agemmNT( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC )
   const int                  K, LDA, LDB, LDC, M, N;
   const HPLAI_T_AFLOAT               ALPHA, BETA;
   const HPLAI_T_AFLOAT               * A, * B;
   HPLAI_T_AFLOAT                     * C;
...
#else
static void HPLAI_agemmTN( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC )
   const int                  K, LDA, LDB, LDC, M, N;
   const HPLAI_T_AFLOAT               ALPHA, BETA;
   const HPLAI_T_AFLOAT               * A, * B;
   HPLAI_T_AFLOAT                     * C;
...
#else
static void HPLAI_agemmTT( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC )
   const int                  K, LDA, LDB, LDC, M, N;
   const HPLAI_T_AFLOAT               ALPHA, BETA;
   const HPLAI_T_AFLOAT               * A, * B;
   HPLAI_T_AFLOAT                     * C;
...
#else
static void HPLAI_agemm0( TRANSA, TRANSB, M, N, K, ALPHA, A, LDA, B, LDB,
                        BETA, C, LDC )
...
#endif
{
   ...
   if( TRANSB == HplNoTrans )
   {
      ...
      { HPLAI_agemmNN( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC ); }
      else
      { HPLAI_agemmTN( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC ); }
   }
   else
   {
      if( TRANSA == HplNoTrans )
      { HPLAI_agemmNT( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC ); }
      else
      { HPLAI_agemmTT( M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC ); }
   }
}
 ...
 * =======
 *
 * HPLAI_agemm performs one of the matrix-matrix operations
 *  
 ...
 *         max(1,k).
 *
 * B       (local input)                 const HPLAI_T_AFLOAT *
 ...
 *         not be set on input.
 *
 * C       (local input/output)          HPLAI_T_AFLOAT *
 ...
 */ 
   ...
   {
      HPLAI_agemm0( TRANSA, TRANSB, M, N, K, ALPHA, A, LDA, B, LDB, BETA,
                  C, LDC );
   }
   else
   {
      HPLAI_agemm0( TRANSB, TRANSA, N, M, K, ALPHA, B, LDB, A, LDA, BETA,
                  C, LDC );
   }
#endif
