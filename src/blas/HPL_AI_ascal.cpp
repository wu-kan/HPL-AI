 ...
 * =======
 *
 * HPL_AI_ascal scales the vector x by alpha.
 * 
 *
 * Arguments
 * =========
 ...
 *
 * X       (local input/output)          HPL_AI_T_afloat *
 ...
 */ 
   ...
   register HPL_AI_T_afloat           x0, x1, x2, x3, x4, x5, x6, x7;
