 ...
 * =======
 *
 * HPL_AI_aaxpy scales the vector x by alpha and adds it to y.
 * 
 *
 * Arguments
 * =========
 ...
 */ 
   ...
   register const HPL_AI_T_afloat     alpha = ALPHA;
   register HPL_AI_T_afloat           x0, x1, x2, x3, y0, y1, y2, y3;
   const HPL_AI_T_afloat              * StX;
   register int              i;
   int                       nu;
