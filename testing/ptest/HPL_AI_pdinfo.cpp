 ...
 * =======
 *
 * HPL_AI_pdinfo reads  the  startup  information for the various tests and
 ...
 */
      ...
      { 
         HPL_pwarn( stderr, __LINE__, "HPL_AI_pdinfo",
 ...
 */
      ...
      {
         HPL_pwarn( stderr, __LINE__, "HPL_AI_pdinfo", "cannot open file %s.",
                    file );
         error = 1; goto label_error;
      }
/*
 ...
 */
      ...
      {
         HPL_pwarn( stderr, __LINE__, "HPL_AI_pdinfo", "%s %d",
 ...
 */
      ...
      {
         HPL_pwarn( stderr, __LINE__, "HPL_AI_pdinfo", "%s %s %d",
