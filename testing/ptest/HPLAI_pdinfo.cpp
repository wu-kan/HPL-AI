 ...
 */
      ...
      { 
         HPL_pwarn( stderr, __LINE__, "HPLAI_pdinfo",
 ...
 */
      ...
      {
         HPL_pwarn( stderr, __LINE__, "HPLAI_pdinfo", "cannot open file %s.",
                    file );
         error = 1; goto label_error;
      }
/*
 ...
 */
      ...
      {
         HPL_pwarn( stderr, __LINE__, "HPLAI_pdinfo", "%s %d",
 ...
 */
      ...
      {
         HPL_pwarn( stderr, __LINE__, "HPLAI_pdinfo", "%s %s %d",
