 ...
 */
   HPL_AI_pdinfo(&test, &ns, nval, &nbs, nbval, &pmapping, &npqs, pval, qval,
 ...
 */
                              ...
                              HPL_AI_pdtest(&test, &grid, &algo, nval[in], nbval[inb]);
                           }
                        }
                     }
                  }
